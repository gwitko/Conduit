...
import 'package:conduit/features/hosts/presentation/widgets/hardware_keys_editor.dart';
...
class HostAuthenticationSection extends StatelessWidget {
  const HostAuthenticationSection({
    ...
    required this.hardwareKeyError,
    required this.requiredValidator,
    ...
    required this.onPasteHardwareKey,
    required this.onImportHardwareKey,
    required this.onRemoveHardwareKey,
    required this.onViewHardwareKey,
  ...
  final List<SshKeyInspection> hardwareKeyInspections;
  final String? hardwareKeyError;
  final FormFieldValidator<String> requiredValidator;
  ...
  final VoidCallback onPasteHardwareKey;
  final VoidCallback onImportHardwareKey;
  final ValueChanged<int> onRemoveHardwareKey;
  final ValueChanged<int> onViewHardwareKey;
      ...
      children: [
        ...
        if (authMethod == SshAuthMethod.hardwareKey) ...[
          ...
          HardwareKeysEditor(
            ...
            onImport: onImportHardwareKey,
            onPaste: onPasteHardwareKey,
            onRemove: onRemoveHardwareKey,
            onView: onViewHardwareKey,
          ),
          const SizedBox(height: 10),
          _ForwardAgentSwitch(
            value: forwardAgent,
...
class _ForwardAgentSwitch extends StatelessWidget {
  const _ForwardAgentSwitch({required this.value, required this.onChanged});
