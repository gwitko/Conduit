...
void main() {
  ...
  group('PredictiveEcho', () {
    test('predicts printable characters at the cursor, advancing the column', () {
      final echo = laggy();
      echo.recordInput(
        'ls',
        inputNum: 5,
    ...
    test('hides predictions when the link is not laggy enough', () {
      final echo = PredictiveEcho()..updateSrtt(const Duration(milliseconds: 5));
      echo.recordInput(
        'a',
        inputNum: 1,
        cursorRow: 0,
    ...
    test('freezes on a control key and stops predicting', () {
      ...
      // "cd" predicted, the \r freezes; further typing isn't predicted.
    ...
    test('does not predict across a line wrap', () {
      ...
      // Only columns 78 and 79 fit; the third character is suppressed.
