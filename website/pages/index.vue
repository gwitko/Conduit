        ...
        <div class="order-1 lg:order-2">
          ...
          <div class="mt-8 grid gap-px overflow-hidden rounded-2xl border border-border bg-border sm:grid-cols-2">
            <div class="bg-panel p-6">
              <p class="text-sm font-semibold text-ink">{{ t('security.cards.keys.title') }}</p>
              <p class="mt-2 text-sm leading-relaxed text-ink-muted">
                {{ t('security.cards.keys.body') }}
              </p>
            </div>
            <div class="bg-panel p-6">
              <p class="text-sm font-semibold text-ink">{{ t('security.cards.enclave.title') }}</p>
              <p class="mt-2 text-sm leading-relaxed text-ink-muted">
                {{ t('security.cards.enclave.body') }}
              </p>
            </div>
          </div>
        </div>
